  ...
  return (
    <>
      {/*
        ...
        - 768px–1199px: tight px-4 so 6 items fit without overflow (set via base px-4 class)
        - 1200px+:      restore the original generous px-14 spacing
        Nothing below md (768px) is touched — mobile menu is unchanged.
      */}
      <style>{`
        @media (min-width: 1200px) {
          .nav-desktop-link {
            padding-left: 3.5rem !important;   /* px-14 = 56px */
                ...
                {item.dropdown ? (
                  <>
                    {item.href ? (
                      <Link
                        href={item.href}
                        /* px-4 base keeps items tight on 768–1199px;
                           nav-desktop-link overrides to px-14 at 1200px+ */
                        className="nav-desktop-link flex items-center gap-1.5 px-4 py-4 text-sm font-semibold tracking-wide text-gray-100 hover:text-amber-400 transition-colors duration-150"
                      >
                        {item.label}
                        <Chevron />
                      </Link>
                    ) : (
                      <button className="nav-desktop-link flex items-center gap-1.5 px-4 py-4 text-sm font-semibold tracking-wide text-gray-100 hover:text-amber-400 transition-colors duration-150 focus:outline-none">
                        {item.label}
                        <Chevron />
                      </button>
                    )}
                  ...
                  <Link
                    href={item.href}
                    className="nav-desktop-link flex items-center px-4 py-4 text-sm font-semibold tracking-wide text-gray-100 hover:text-amber-400 transition-colors duration-150"
                  >
                    {item.label}
                  </Link>
                )}
